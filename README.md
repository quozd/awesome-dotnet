...
* [Free Services & Tools for Open Source .NET Projects](https://github.com/Microsoft/dotnet/blob/master/dotnet-free-oss-services.md) - This community maintained list showcases free tools and services for open source software development on .NET.
