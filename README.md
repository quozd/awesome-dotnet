...
* [Crypto-Notepad](https://github.com/Crypto-Notepad/Crypto-Notepad) - Notepad-like simple text editor for Windows, where files are saved and loaded encrypted with AES algorithms.
