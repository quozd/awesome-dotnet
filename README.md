...
* [Yauaa.Netstandard](https://github.com/OrbintSoft/yauaa.netstandard) This library provides a semantic user agent parsing and extract all relevant informations (browser, operating system, device name, etc..)
