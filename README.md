...
* [MobileSuit](https://github.com/Plastic-Metal/MobileSuit) - Best way to build .NET CLI Application, which maps methods of class into commands, providing Themes API, IO interfaces, auto parsing and Log. 
