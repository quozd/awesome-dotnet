...
* [SmartStoreNET](https://github.com/smartstoreag/SmartStoreNET) - Free ASP.NET MVC e-commerce Shopping Cart Solution forked from [NopCommerce](https://www.nopcommerce.com) but violates nopCommerce license : Read [Here](https://www.nopcommerce.com/boards/t/24110/smartstorenet.aspx) and [Here](https://www.nopcommerce.com/boards/t/24760/smartstore-rejected-to-meet-nopcommerce-license-terms-lets-discuss.aspx) 
...
* [GrandNode](https://github.com/grandnode/grandnode) - GrandNode is a functional cross-platform e-commerce solution forked from [NopCommerce](https://www.nopcommerce.com) developed for the most demanding users. You are able to run it on any system - Linux, Windows, Mac. GrandNode supports Docker, so you can install it with Docker for Linux containers. Scalable e-commerce solution which can be adapted in any company independently from company size or industry. 
