...
* [NanoRabbit](https://github.com/cgcel/NanoRabbit) - NanoRabbit, A Lightweight RabbitMQ .NET API for .NET 6, which makes a simple way to manage Multiple connections, producers, consumers, and easy to use.
