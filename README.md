...
* [ML.NET.Classifier](https://github.com/Bgajski/ML.NET.Classifier) - Binary and textual classifier built on ML.NET with training, evaluation, and performance modules.
