...
* [Websocket.Client](https://github.com/Marfusios/websocket-client) - A wrapper over native C# class ClientWebSocket with built-in reconnection and error handling.
