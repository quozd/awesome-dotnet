...
* [Simplify.FluentNHibernate](https://github.com/SimplifyNet/Simplify/wiki/Simplify.FluentNHibernate) - Fluent NHibernate easy configuration, session extensions and more.
