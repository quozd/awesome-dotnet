...
* [OKHOSTING.ORM](https://github.com/okhosting/OKHOSTING.ORM) - Flexible, simple, feature complete, multi-database, multi-platform ORM. Works with any class, any naming convention, and most used databases.
