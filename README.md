...
* [DWKit](https://dwkit.com) - DWKit is a BPM based on .NET Core and React/Redux, and includes Business processes, Workflow, Forms in a self-hosted or cloud .NET Core solution. **[$]**
